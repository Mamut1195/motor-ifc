...
def semantic_uuid(authority_producer:str,model_id:UUID,discipline:str,source_id:str,role:str)->uuid.UUID:
    name=json.dumps((authority_producer,str(model_id),discipline,source_id,role),ensure_ascii=False,separators=(",",":"))
...
def global_id(authority_producer:str,model_id:UUID,discipline:str,source_id:str,role:str)->str:
    return _compress(semantic_uuid(authority_producer,model_id,discipline,source_id,role))
